...
class JotForm {
    ...
    public function __construct() {
        ...
        $this->apiVersion= config('jotform.api_version', 'v1');
        $this->apiKey =  config('jotform.api_key', '');
        $this->debugMode = config('jotform.debug_mode', false);
        $this->outputType = strtolower(config('jotform.output_type', 'json'));
        $user = $this->getUser();
